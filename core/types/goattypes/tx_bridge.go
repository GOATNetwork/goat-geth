...
func (tx *DepositTx) MethodId() [4]byte {
	// deposit(bytes32 txid, uint32 txout, address target, uint256 amount)
...
func (tx *NewBtcBlockTx) Claim() *Mint {
	return nil
}
