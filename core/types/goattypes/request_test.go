...
func TestDecodeRequests(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantBridge: BridgeRequests{
				Withdraws: []*WithdrawalRequest{
					{Id: 1, Amount: 0xc60f7e8e, TxPrice: 10, Address: "127Mfvbp7SskVw9puUkNdp8iJpWiavioU1"},
				},
			},
		},
		{
			...
			wantRelayer: RelayerRequests{
				Adds: []*AddVoterRequest{
					{
						Voter:  common.HexToAddress("0x2968b8d4964038128c9c5df7f85742e4955030aa"),
						Pubkey: common.HexToHash("0x3a473b1cf506a1b9688a70a6b118c37c37c1e809e3ab20143c66b4d2cb9d4db3"),
					},
				},
			},
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bridge1, relayer1, locking1, err := DecodeRequests(requests)
