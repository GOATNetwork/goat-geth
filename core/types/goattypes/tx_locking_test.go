...
func TestCompleteUnlockTx(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			mint: &Mint{Address: common.HexToAddress("0x5B38Da6a701c568545dCfcB03FcB875f56beddC4"), Amount: big.NewInt(1), Tax: big.NewInt(0)},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := tx.Withdraw(); !reflect.DeepEqual(got, tt.mint) {
				t.Errorf("CompleteUnlockTx.Withdraw(%+v) != want %+v", got, tt.mint)
			}
...
func TestDistributeRewardTx(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			mint: &Mint{Address: common.HexToAddress("0x9ae387acdafe4b9d315d0bb56b06ab91f31b9670"), Amount: big.NewInt(100), Tax: big.NewInt(0)},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
