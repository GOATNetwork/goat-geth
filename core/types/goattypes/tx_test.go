...
func TestTxDecode(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				data:   hexutil.MustDecode(""),
			},
			want: &DepositTx{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := DecodeTx(tt.args.module, tt.args.action, tt.args.data)
