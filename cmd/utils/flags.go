...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	flags.CheckExclusive(ctx, MainnetFlag, DeveloperFlag, SepoliaFlag, HoleskyFlag, HoodiFlag, GoatNetworkFlag, NetworkIdFlag, OverrideGenesisFlag)
...
func MakeGenesis(ctx *cli.Context) *core.Genesis {
	...
	case ctx.IsSet(GoatNetworkFlag.Name):
		...
		switch netwk {
		case params.GoatMainnetName:
			Fatalf("This release is for testnet3 only, mainnet is not supported")
		case params.GoatTestnet3Name:
